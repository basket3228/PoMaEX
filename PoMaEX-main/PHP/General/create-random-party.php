...
<head>
    ...
    <link rel="stylesheet" href="../../CSS/General/create-random-party.css">
</head>
...
<body>
    <div class="container">
        <header id="header">
            ...
            <nav>
                <ul id="nav-list">
                    <li id="list1"><a href="party-list.php">編成一覧</a></li>
                    <li id="list2"><a href="trainer-list.php">バディーズ一覧</a></li>
                    <li id="list3"><a href="https://ng-pomatools.web.app/pairs/900000/2500" target="_blank">PoMaTool</a></li>
                    <li id="list4"><a href="create-random-party.php">乱数編成生成</a></li>
                </ul>
            </nav>
        </header>
    ...
    <script src="../../JS/General/create-random-party.js"></script>
</body>
