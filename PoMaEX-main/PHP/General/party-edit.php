    ...
    <aside class="sidebar">
        <ul class="edit-trainer">
            <?php foreach ($trainers as $trainer) { ?>
                <li class="party-detail CS-<?php echo special($trainer['type_name']) ?>-detail column-2_item" style="margin-bottom: calc(16px + 1vw)" draggable="true">
                    <div class="role">
                    ...
                    <img src="../../trainer/<?= special($trainer['trainer_name']) ?>.png" draggable="false">
