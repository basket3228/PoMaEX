...
<div class="container">
    ...
    <main class="main">
        ...
        <ul class="party-list">
            <li class="enemy">
                <h2><a href="LGsearch.php?enemy_id=<?= special($e1['enemy_id1']) ?>&LG_id=<?= special($e1['LG_id']) ?>&category_id=<?= $category_id ?>"><button><?php echo special($e1['e1']) ?></button></a></h2>
                <ul class="party">
            ...
            <li class="enemy">
                <h2><a href="LGsearch.php?enemy_id=<?= special($e2['enemy_id2']) ?>&LG_id=<?= special($e1['LG_id']) ?>&category_id=<?= $category_id ?>"><button><?php echo special($e2['e2']) ?></button></a></h2>
                <ul class="party">
                    <?php foreach ($parties as $party) { ?>
                        <?php if ($party['trainer_name'] != null) { ?>
            ...
            <li class="enemy">
                <h2><a href="LGsearch.php?enemy_id=<?= special($e3['enemy_id3']) ?>&LG_id=<?= $LG_id ?>&category_id=<?= $category_id ?>"><button><?php echo special($e3['e3']) ?></button></a></h2>
                <ul class="party">
                    <?php foreach ($parties as $party) { ?>
                        <?php if ($party['trainer_name'] != null) { ?>
