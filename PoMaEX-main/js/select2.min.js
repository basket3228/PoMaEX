    ...
    e.define("select2/data/base", ["../utils"], function (n) {
      ...
      return (
        ...
        (s.prototype.generateResultId = function (e, t) {
          e = e.id + "-result-";
          return (
            (e += n.generateChars(4)), null != t.id ? (e += "-" + t.id.toString()) : (e += "-" + n.generateChars(4)), e
          );
        }),
        s
      );
        ...
        (e.prototype.tokenizer = function (e, t, n, s) {
          for (
            ...
            -1 === i.indexOf(l)
              ? r++
              : ((l = o.substr(0, r)),
                null == (l = a(c.extend({}, t, { term: l }))) ? r++ : (s(l), (o = o.substr(r + 1) || ""), (r = 0)));
          }
          return { term: o };
        }),
        e
        ...
        (e.prototype.fromElement = function (e) {
          ...
          for (var i = 0; i < e[0].attributes.length; i++) {
            ...
            o.substr(0, r.length) == r &&
              ((o = o.substring(r.length)), (r = u.GetData(e[0], o)), (n[o.replace(/-([a-z])/g, s)] = r));
          }
